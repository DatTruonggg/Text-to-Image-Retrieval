...
class object_retrieval(load_file):
    def __init__(
            self,
            clean_data_path = {
                'bbox':'data/OD/bboxes_encoded/*',
                'class':'data/OD/classes_encoded/*',
                'color':'data/color/colors_encoded/*',
                'tag':'data/tag/*',
                'number':'data/OD/number_encoded/*',
            },
            update:bool=False,
            save_tfids_object_path = os.path.join(PROJECT_ROOT, 'data/bin/contexts_bin'),
            save_corpus_path = 'data/tag/tag_corpus.txt'
    ):
